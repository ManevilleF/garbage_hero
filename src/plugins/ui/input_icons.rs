...
pub const fn xbox_icon(button: GamepadButtonType) -> Option<&'static str> {
    match button {
        ...
        GamepadButtonType::LeftTrigger => Some("kenney_input-prompts/Xbox/xbox_lt.png"),
        GamepadButtonType::LeftTrigger2 => Some("kenney_input-prompts/Xbox/xbox_lb.png"),
        GamepadButtonType::RightTrigger => Some("kenney_input-prompts/Xbox/xbox_rt.png"),
        GamepadButtonType::RightTrigger2 => Some("kenney_input-prompts/Xbox/xbox_rb.png"),
        GamepadButtonType::Select => Some("kenney_input-prompts/Xbox/xbox_button_menu.png"),
        GamepadButtonType::Start => Some("kenney_input-prompts/Xbox/xbox_button_start.png"),
...
pub const fn steamdeck_icon(button: GamepadButtonType) -> Option<&'static str> {
    match button {
        ...
        GamepadButtonType::Select => Some("kenney_input-prompts/SteamDeck/steamdeck_button_options.png"),
        GamepadButtonType::Start => Some("kenney_input-prompts/SteamDeck/steamdeck_button_quickaccess.png"),
